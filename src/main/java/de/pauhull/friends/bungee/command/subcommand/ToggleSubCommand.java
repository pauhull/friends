    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if (args[0].equalsIgnoreCase("togglemsg")) {
            friends.getSettingsTable().getMessages(player.getUniqueId(), messages -> {
                ...
                if (!messages) {
                    player.sendMessage(TextComponent.fromLegacyText(BungeeFriends.getPrefix() + friends.getMessages().getMessagesOn()));
                } else {
                    player.sendMessage(TextComponent.fromLegacyText(BungeeFriends.getPrefix() + friends.getMessages().getMessagesOff()));
                }
            });
            ...
            friends.getSettingsTable().getNotifications(player.getUniqueId(), notifications -> {
                ...
                if (!notifications) {
                    player.sendMessage(TextComponent.fromLegacyText(BungeeFriends.getPrefix() + friends.getMessages().getNotificationsOn()));
                } else {
                    player.sendMessage(TextComponent.fromLegacyText(BungeeFriends.getPrefix() + friends.getMessages().getNotificationsOff()));
                }
            });
            ...
            friends.getSettingsTable().getJumping(player.getUniqueId(), jumping -> {
                ...
                if (!jumping) {
                    player.sendMessage(TextComponent.fromLegacyText(BungeeFriends.getPrefix() + friends.getMessages().getJumpingOn()));
                } else {
                    player.sendMessage(TextComponent.fromLegacyText(BungeeFriends.getPrefix() + friends.getMessages().getJumpingOff()));
                }
            });
            ...
            friends.getSettingsTable().getRequests(player.getUniqueId(), requests -> {
                ...
                if (!requests) {
                    player.sendMessage(TextComponent.fromLegacyText(BungeeFriends.getPrefix() + friends.getMessages().getRequestsOn()));
                } else {
                    player.sendMessage(TextComponent.fromLegacyText(BungeeFriends.getPrefix() + friends.getMessages().getRequestsOff()));
                }
            });
        }
